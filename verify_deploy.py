...
MANIFEST = {
    ...
    "run_all_tests.sh":
        "9bc533ca37361b27b85066386499174fe5d3a34e4cf510b5c50919e08639359d",   # 2026-09-03: F2 (test_f2_distill_loop) joined the runner; pin moved in the same change (M53)
