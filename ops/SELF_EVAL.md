...
## 2026-09-20T20:01:42Z  overall FAIL  (round 4980)
nodes     PASS  3/3 up, height 38 (spread 0), source 39341fb726a9
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
...
trader    FAIL  log 7.0h old; freshness exit 0: RAN: a cycle dated 2026-09-20 COMPLETED -- the trader printed it, not the launcher. -- BUT the last cycle did not finish clean: exit 3: a required seal failed -- detail above and in trader_log.txt
repo      PASS  core 39341fb726a9 matches MANIFEST.sha256. This compares the manifest only; a substitution that also rewrote the manifest would read clean here
git       PASS  HEAD 3d6801b, 0 ahead / 0 behind origin/main as of the last fetch; last fetch 28.6h ago; 18 file(s) not committed
disk      PASS  319G free of 476G (32% used); logs/ 25M

## 2026-09-20T21:09:04Z  overall FAIL  (round 5040)
nodes     PASS  3/3 up, height 38 (spread 0), source 39341fb726a9
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
judge     PASS  baseline digest student@9a2bbf97a69, 1 model(s)
self      PASS  running watchdog matches its file on disk (P14)
alerts    WARN  3 live -- first: node A: mesh is running more than one source: we are 39341fb726a9, peers report ['24fc72076de9'] (last heard 1
trader    FAIL  log 8.2h old; freshness exit 0: RAN: a cycle dated 2026-09-20 COMPLETED -- the trader printed it, not the launcher. -- BUT the last cycle did not finish clean: exit 3: a required seal failed -- detail above and in trader_log.txt
repo      PASS  core 39341fb726a9 matches MANIFEST.sha256. This compares the manifest only; a substitution that also rewrote the manifest would read clean here
git       PASS  HEAD 3d6801b, 0 ahead / 0 behind origin/main as of the last fetch; last fetch 29.7h ago; 19 file(s) not committed
disk      PASS  319G free of 476G (32% used); logs/ 26M

## 2026-09-20T22:16:20Z  overall FAIL  (round 5100)
nodes     PASS  3/3 up, height 38 (spread 0), source 39341fb726a9
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
judge     PASS  baseline digest student@9a2bbf97a69, 1 model(s)
self      PASS  running watchdog matches its file on disk (P14)
alerts    WARN  3 live -- first: node A: mesh is running more than one source: we are 39341fb726a9, peers report ['24fc72076de9'] (last heard 8
trader    FAIL  log 9.3h old; freshness exit 0: RAN: a cycle dated 2026-09-20 COMPLETED -- the trader printed it, not the launcher. -- BUT the last cycle did not finish clean: exit 3: a required seal failed -- detail above and in trader_log.txt
repo      PASS  core 39341fb726a9 matches MANIFEST.sha256. This compares the manifest only; a substitution that also rewrote the manifest would read clean here
...
## 2026-09-21T06:06:18Z  overall FAIL  (round 5520)
nodes     PASS  3/3 up, height 38 (spread 0), source 35bff56c70dd
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
judge     PASS  baseline digest student@9a2bbf97a69, 1 model(s)
self      PASS  running watchdog matches its file on disk (P14)
alerts    WARN  3 live -- first: node A: mesh is running more than one source: we are 35bff56c70dd, peers report ['39341fb726a9'] (last heard 4
trader    FAIL  log 17.1h old; freshness exit 0: NOT YET DUE: trigger 09:00 plus 5 min grace has not passed. -- BUT the last cycle did not finish clean: exit 3: a required seal failed -- detail above and in trader_log.txt
repo      PASS  core 35bff56c70dd matches MANIFEST.sha256. This compares the manifest only; a substitution that also rewrote the manifest would read clean here
git       PASS  HEAD 3455312, 0 ahead / 0 behind origin/main as of the last fetch; last fetch 38.7h ago; 20 file(s) not committed
disk      PASS  304G free of 476G (36% used); logs/ 25M

## 2026-09-21T07:12:57Z  overall FAIL  (round 5580)
nodes     PASS  3/3 up, height 38 (spread 0), source 35bff56c70dd
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
judge     PASS  baseline digest student@9a2bbf97a69, 1 model(s)
self      PASS  running watchdog matches its file on disk (P14)
alerts    WARN  2 live -- first: node A: mesh is running more than one source: we are 35bff56c70dd, peers report ['39341fb726a9'] (last heard 8
trader    FAIL  log 18.2h old; freshness exit 0: NOT YET DUE: trigger 09:00 plus 5 min grace has not passed. -- BUT the last cycle did not finish clean: exit 3: a required seal failed -- detail above and in trader_log.txt
repo      PASS  core 35bff56c70dd matches MANIFEST.sha256. This compares the manifest only; a substitution that also rewrote the manifest would read clean here
git       PASS  HEAD 3455312, 0 ahead / 0 behind origin/main as of the last fetch; last fetch 39.8h ago; 21 file(s) not committed
disk      PASS  304G free of 476G (36% used); logs/ 25M

## 2026-09-21T08:19:35Z  overall FAIL  (round 5640)
nodes     PASS  3/3 up, height 39 (spread 0), source 35bff56c70dd
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
judge     PASS  baseline digest student@8571b16b178, 1 model(s)
self      PASS  running watchdog matches its file on disk (P14)
alerts    WARN  2 live -- first: node A: mesh is running more than one source: we are 35bff56c70dd, peers report ['39341fb726a9'] (last heard 2
trader    FAIL  log 19.3h old; freshness exit 0: NOT YET DUE: trigger 09:00 plus 5 min grace has not passed. -- BUT the last cycle did not finish clean: exit 3: a required seal failed -- detail above and in trader_log.txt
repo      PASS  core 35bff56c70dd matches MANIFEST.sha256. This compares the manifest only; a substitution that also rewrote the manifest would read clean here
git       PASS  HEAD 3455312, 0 ahead / 0 behind origin/main as of the last fetch; last fetch 40.9h ago; 31 file(s) not committed
disk      PASS  304G free of 476G (36% used); logs/ 25M

## 2026-09-21T09:26:09Z  overall FAIL  (round 5700)
nodes     PASS  3/3 up, height 39 (spread 0), source 35bff56c70dd
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
judge     PASS  baseline digest student@8571b16b178, 1 model(s)
self      PASS  running watchdog matches its file on disk (P14)
alerts    WARN  2 live -- first: node A: mesh is running more than one source: we are 35bff56c70dd, peers report ['39341fb726a9'] (last heard 3
trader    FAIL  log 20.4h old; freshness exit 0: NOT YET DUE: trigger 09:00 plus 5 min grace has not passed. -- BUT the last cycle did not finish clean: exit 3: a required seal failed -- detail above and in trader_log.txt
repo      PASS  core 35bff56c70dd matches MANIFEST.sha256. This compares the manifest only; a substitution that also rewrote the manifest would read clean here
git       PASS  HEAD 3455312, 0 ahead / 0 behind origin/main as of the last fetch; last fetch 42.0h ago; 31 file(s) not committed
disk      PASS  304G free of 476G (36% used); logs/ 26M

## 2026-09-21T10:32:51Z  overall FAIL  (round 5760)
nodes     PASS  3/3 up, height 39 (spread 0), source 35bff56c70dd
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
judge     PASS  baseline digest student@8571b16b178, 1 model(s)
self      PASS  running watchdog matches its file on disk (P14)
alerts    WARN  2 live -- first: node A: mesh is running more than one source: we are 35bff56c70dd, peers report ['39341fb726a9'] (last heard 7
trader    FAIL  log 21.5h old; freshness exit 0: NOT YET DUE: trigger 09:00 plus 5 min grace has not passed. -- BUT the last cycle did not finish clean: exit 3: a required seal failed -- detail above and in trader_log.txt
repo      PASS  core 35bff56c70dd matches MANIFEST.sha256. This compares the manifest only; a substitution that also rewrote the manifest would read clean here
...
## 2026-09-21T17:20:17Z  overall FAIL  (round 6120)
nodes     PASS  3/3 up, height 39 (spread 0), source 15896d5c757e
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
judge     PASS  baseline digest student@9a2bbf97a69, 1 model(s)
self      PASS  running watchdog matches its file on disk (P14)
alerts    WARN  3 live -- first: node A: mesh is running more than one source: we are 15896d5c757e, peers report ['35bff56c70dd'] (last heard 8
trader    FAIL  log 4.3h old; freshness exit 0: RAN: a cycle dated 2026-09-21 COMPLETED -- the trader printed it, not the launcher. -- BUT the last cycle did not finish clean: SEAL  FAILED -- HTTP 500: {"error": "HTTP Error 500: INTERNAL SERVER ERROR"}
repo      PASS  core 15896d5c757e matches MANIFEST.sha256. This compares the manifest only; a substitution that also rewrote the manifest would read clean here
git       PASS  HEAD ecc61f0, 0 ahead / 0 behind origin/main as of the last fetch; last fetch 49.9h ago; 26 file(s) not committed
disk      PASS  304G free of 476G (36% used); logs/ 26M

## 2026-09-21T18:34:05Z  overall FAIL  (round 6180)
nodes     PASS  3/3 up, height 39 (spread 0), source d32e18d931f0
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
judge     PASS  baseline digest student@9a2bbf97a69, 1 model(s)
self      PASS  running watchdog matches its file on disk (P14)
alerts    WARN  2 live -- first: node A: mesh is running more than one source: we are d32e18d931f0, peers report ['15896d5c757e'] (last heard 4
trader    FAIL  log 5.6h old; freshness exit 0: RAN: a cycle dated 2026-09-21 COMPLETED -- the trader printed it, not the launcher. -- BUT the last cycle did not finish clean: SEAL  FAILED -- HTTP 500: {"error": "HTTP Error 500: INTERNAL SERVER ERROR"}
repo      PASS  core d32e18d931f0 matches MANIFEST.sha256. This compares the manifest only; a substitution that also rewrote the manifest would read clean here
...
## 2026-09-21T21:15:32Z  overall FAIL  (round 6300)
nodes     PASS  3/3 up, height 39 (spread 0), source 447ed5ecdffc
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
judge     PASS  baseline digest student@9a2bbf97a69, 1 model(s)
self      PASS  running watchdog matches its file on disk (P14)
alerts    WARN  3 live -- first: node A: mesh is running more than one source: we are 447ed5ecdffc, peers report ['d32e18d931f0'] (last heard 4
trader    FAIL  log 8.3h old; freshness exit 0: RAN: a cycle dated 2026-09-21 COMPLETED -- the trader printed it, not the launcher. -- BUT the last cycle did not finish clean: SEAL  FAILED -- HTTP 500: {"error": "HTTP Error 500: INTERNAL SERVER ERROR"}
repo      PASS  core 447ed5ecdffc matches MANIFEST.sha256. This compares the manifest only; a substitution that also rewrote the manifest would read clean here
git       PASS  HEAD 9cfa349, 0 ahead / 0 behind origin/main as of the last fetch; last fetch 53.8h ago; 45 file(s) not committed
disk      PASS  301G free of 476G (36% used); logs/ 26M

## 2026-09-21T22:31:00Z  overall FAIL  (round 6360)
nodes     PASS  3/3 up, height 39 (spread 0), source 18cc3fb577b5
mycelium  PASS  3/3 reporting; links held: A=2, B=2, C=1
judge     PASS  baseline digest student@9a2bbf97a69, 1 model(s)
self      PASS  running watchdog matches its file on disk (P14)
alerts    WARN  3 live -- first: node A: mesh is running more than one source: we are 18cc3fb577b5, peers report ['447ed5ecdffc'] (last heard 4
trader    FAIL  log 9.5h old; freshness exit 0: RAN: a cycle dated 2026-09-21 COMPLETED -- the trader printed it, not the launcher. -- BUT the last cycle did not finish clean: SEAL  FAILED -- HTTP 500: {"error": "HTTP Error 500: INTERNAL SERVER ERROR"}
