...
Never touches: the node wrappers (their command line runs run_node.py; the
old launcher name was retired on 2026-09-12 once every node had been
restarted under the new one), the watchdog, this process, or its own console.
"""
...
NEVER = ("run_node", "covenant_watchdog", "AJ_CLEANUP",
         "cleanup_consoles")
