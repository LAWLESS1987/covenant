...
| **GitHub Actions, private** (`covenant-phone`, 2026-09-12) | building the phone app against this public core, proving it on an x86_64 emulator, keeping the APK as the run's artifact in the operator's private repository | arm64 on a real phone, the Start button's tap path, Samsung's sleep policy |
